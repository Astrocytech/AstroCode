  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all astrocoder sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific astrocoder session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new astrocoder session for interacting with AI assistants and managing conversations.",

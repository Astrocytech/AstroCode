...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/astrocoder.git")).toEqual({ owner: "sst", repo: "astrocoder" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/astrocoder")).toEqual({ owner: "sst", repo: "astrocoder" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/astrocoder.git")).toEqual({ owner: "sst", repo: "astrocoder" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/astrocoder")).toEqual({ owner: "sst", repo: "astrocoder" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/astrocoder.git")).toEqual({ owner: "sst", repo: "astrocoder" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/astrocoder")).toEqual({ owner: "sst", repo: "astrocoder" })
})
